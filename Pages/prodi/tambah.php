    ...
    <form action="" method="post" style="margin-left: 20px;">
        <table>
            ...
            <tr>
                ...
                <td>:</td>
                <td><input type="text" id="prodi_kd" name="prodi_kd" required></td>
            </tr>
            <tr>
                <td><label for="prodi_nama">Nama</label></td>
                <td>:</td>
                <td><input type="text" id="prodi_nama" name="prodi_nama" required></td>
            </tr>
            <tr>
                <td><label for="prodi_jenjang">Jenjang</label></td>
                <td>:</td>
                <td>
                    <input type="text" id="prodi_jenjang" name="prodi_jenjang" required>
                </td>
            </tr>
            <tr>
                <td>
